...
public class SetLoc implements CommandExecutor {
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        ...
        if (existingCrate == null) {
            ...
            if (crate != null) {
                Util.registerCrate(crateLoc, crate);
                src.sendMessage(Util.prefix.concat(Util.toText("&7Successfully registered this block as a &f" + crate.Name + " &7crate!")));
            ...
            src.sendMessage(Util.prefix.concat(Util.toText("&7This block is already a &f" + existingCrate.Name + " &7crate!")));
            return CommandResult.empty();
        }
    }
}
