...
public class Utils {
    ...
    public static ItemStack createSkull(String texture, String name, String lore) {
        ...
        profile.getPropertyMap().put("textures", ProfileProperty.of("textures", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUv" + texture));
