...
public class Announce implements CommandExecutor {
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        ...
        Boolean newAnnounce = args.<Boolean>getOne("new-announce").get();
        Boolean oldAnnounce = reward.isAnnounce();
        reward.setAnnounce(newAnnounce);
        TeslaCrate.sendMessage(src, "teslacrate.command.reward.edit.announce.success", "reward", reward.getName(), "new-announce", newAnnounce, "old-announce", oldAnnounce);
