...
@Plugin(id = "teslacrate", name = "TeslaCrate", version = "3.0.0", dependencies = @Dependency(id = "teslacore"), url = "https://ore.spongepowered.org/Simon_Flash/TeslaCrate", authors = "Simon_Flash")
