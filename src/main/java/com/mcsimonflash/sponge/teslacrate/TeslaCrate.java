...
@Plugin(id = "teslacrate", name = "TeslaCrate", version = "mc1.10.2-v1.1.0", authors = "Simon_Flash", description = "Shockingly powerful crates")
public class TeslaCrate {
    ...
    public void onPostInit(GamePostInitializationEvent event) {
        plugin = this;
        logger.info("+=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=+");
        logger.info("|     TeslaCrate -- Version 1.1.0     |");
